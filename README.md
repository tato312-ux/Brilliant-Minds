...
This was a team project. My name is Hector Rene Conde Chuquimia. My primary contribution focused on the agentic RAG workflow used to retrieve relevant document context and generate grounded responses.
